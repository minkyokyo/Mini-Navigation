                   ...
                   const glm::vec2& uvc = {0.5f,1})
{
    ...
    out.vertices.push_back(Vertex{a, n, uva});
    out.vertices.push_back(Vertex{b, n, uvb});
    out.vertices.push_back(Vertex{c, n, uvc});
                            ...
                            const glm::vec3& c)
{
    ...
    if (len2 <= 1e-12f) return glm::vec3(0,1,0);
...
{
    uint32_t base = static_cast<uint32_t>(out.vertices.size());
    out.vertices.push_back(Vertex{p0, n, {0,0}});
    out.vertices.push_back(Vertex{p1, n, {1,0}});
    out.vertices.push_back(Vertex{p2, n, {1,1}});
    out.vertices.push_back(Vertex{p3, n, {0,1}});
